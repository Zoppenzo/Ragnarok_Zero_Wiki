(() => {
  ...
  if(!document.getElementById(STYLE_ID)){
    ...
    style.textContent=`
      ...
      /* Darker neutral backdrop, mirroring RMS' darker blue page around its sheets. */
      .rz-monster-db-results{background:#c3c9cf!important;padding:12px 10px!important;border:1px solid #a1aab2!important;border-radius:3px!important}
      .rz-monster-sheet-wrap:not(.rz-monster-sheet-wrap-mvp):not(.rz-monster-sheet-wrap-memorial){background:#c3c9cf!important;padding:5px!important;border:1px solid #a1aab2!important;border-radius:3px!important;box-shadow:0 1px 3px rgba(40,50,58,.14)!important}
