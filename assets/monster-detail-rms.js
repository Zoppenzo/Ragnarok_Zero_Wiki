        ...
        <tbody>
          <tr class="rz-monster-main-row">
            <td colspan="2" class="rz-monster-left-block"><table class="rz-monster-subtable"><tbody>
              ...
              <tr><th>Hit (100%)</th><td>${stat(monster,'hit',monster.hit)}</td></tr>
              <tr><th>Flee (95%)</th><td>${stat(monster,'flee',monster.flee)}</td></tr>
              <tr><th>Walk Speed</th><td>${val(monster.walkSpeed)}</td></tr>
              <tr><th>Attack</th><td>${attack}</td></tr>
              <tr><th>Magic Atk</th><td>${magicAttack}</td></tr>
              <tr><th>Def</th><td>${stat(monster,'def',monster.def)}</td></tr>
              <tr><th>Magic Def</th><td>${stat(monster,'mdef',monster.mdef)}</td></tr>
            </tbody></table></td>
